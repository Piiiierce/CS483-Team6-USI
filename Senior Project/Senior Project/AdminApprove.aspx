...
<head runat="server">
    ...
    <link href="../Content/AdminApprove1.css" rel="stylesheet" />
</head>
<body>
    <form id="form1" runat="server">
        ...
        <div class="bg-white border rounded border-dark adminapprove-wrapper">
            ...
            <table class="container justify-content-center">
                <tr>
                    <td class="center">
                        ...
                        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT StartTime, EndTime FROM Reservation WHERE (Date = @Date) AND (ManagerApprove = 1)">
                            <SelectParameters>
                    ...
                    <td>
                        ...
                        <div>
                            <asp:ListBox ID="ListBox1" runat="server" DataSourceID="SqlDataSource2" DataTextField="StartTime" DataValueField="StartTime" DataFormatString="{0:hh':'mm}"></asp:ListBox>

                            &nbsp;&nbsp;
              <asp:ListBox ID="ListBox2" runat="server" DataSourceID="SqlDataSource2" DataTextField="EndTime" DataValueField="EndTime" DataFormatString="{0:hh':'mm}"></asp:ListBox>
                        </div>
                    </td>
                </tr>
            </table>
            ...
            <br />
            <div class="center">
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource1" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" AllowPaging="True" PageSize="6">
                    <Columns>
