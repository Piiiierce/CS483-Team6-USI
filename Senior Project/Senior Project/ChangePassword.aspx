<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ChangePassword.aspx.cs" Inherits="Senior_Project.WebForm3" %>
...
<body>
    <form id="form1" runat="server">
        <div style="font-family: Arial" class="center">
            <table style="border: 1px solid black" class="bg-white border rounded border-dark schedule-wrapper">
                <tr>
                    <td colspan="2">
                        <b>Change Password</b>
                    </td>
